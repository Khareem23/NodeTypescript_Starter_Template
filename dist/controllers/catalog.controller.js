...
var CatalogController = /** @class */ (function () {
    function CatalogController() {
        ...
        this.getAllCatalogs = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var catalogRepo, allCatalogs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        catalogRepo = typeorm_1.getManager().getRepository(Catalog_1.Catalog);
                        return [4 /*yield*/, catalogRepo.find()];
                    case 1:
                        allCatalogs = _a.sent();
        ...
        this.createCatalog = function (req, res) { };
        this.updateCatalog = function (req, res) { };
        this.initRoutes();
    }
    CatalogController.prototype.initRoutes = function () {
